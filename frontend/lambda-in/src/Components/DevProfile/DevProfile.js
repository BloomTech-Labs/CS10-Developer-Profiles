...
class DevProfile extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      summary:
        "Space, the final frontier. These are the voyages of starship Stargazer.",
            ...
            <div className="topCard">
              <div className="topCardLeft">
                ...
                <div className="desiredTitle">
                  <div className="title1">Desired Title:</div>
                  <div className="title2">{this.state.desiredTitle}</div>
                </div>
